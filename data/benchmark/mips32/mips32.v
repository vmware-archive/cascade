include data/benchmark/mips32/alu.v;
include data/benchmark/mips32/alu_control.v;
include data/benchmark/mips32/control.v;
...
(*__target="sw", __file="data/benchmark/mips32/imem.mem"*) 
Memory#(6,32) imem(
  .clock(clock.val),
  .raddr1(pc >> 2), 
  .rdata1(instruction)
...
wire[31:0] reg_read2;
wire[31:0] reg_write;
(*__target="sw", __file="data/benchmark/mips32/reg.mem"*)
Memory#(5,32) regs(
  .clock(clock.val),
  .wen(c_reg_write),
...
wire[31:0] mem_read;
(*__target="sw", __file="data/benchmark/mips32/dmem.mem"*)
Memory#(16,32) dmem(
  .clock(clock.val),
  .wen(mem_write),
  .raddr1(result >> 2),
