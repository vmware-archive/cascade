...
"file"        YY_REC; return yyParser::make_FILE(parser->get_loc());
...
"$fread"    YY_REC; return yyParser::make_SYS_FREAD(parser->get_loc());
"$fwrite"   YY_REC; return yyParser::make_SYS_FWRITE(parser->get_loc());
